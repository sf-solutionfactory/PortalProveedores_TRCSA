var textoBoton;
//$("#btnActionActiDesacti").click(function () {
//        //$('#btnActiDesacti').each(function () {
//        //    textoBoton = $(this).attr("name");
//        //});
...
function workThis(button) {
    ...
    //        textoBoton = $(this).attr("name");
    //});
    //if ($.trim($(button).index()) == 0) {
    //    $('#btnActiDesacti').each(function () {
    //        textoBoton = $(this).attr("name");
    //    });
    //}
    textoBoton = $(button).find('i').attr('name');
    /*console.log(textButton);*/
    //if ($.trim($(button).index()) == 1) {
    //    $('#btnModificar').each(function () {
    //        textoBoton = $(this).attr("name");
    //    });
    //}
    ...
    try {
        ...
        val3 = $.trim(cellsOfRow[2].textContent); //Aquí había error con la clase de noticias
