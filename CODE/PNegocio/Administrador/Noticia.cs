    ...
    public class Noticia
    {
        ...
        public string consultarNoticias(string ancho)
        {
            ...
            if (resultado.Count > 1)
            {
                ...
                //return Gen.Util.CS.Gen.convertToHtmlTableDelete(resultado, "tableToOrder", "tblComun' style='width:" + ancho + ";", listaEvitar, true, true, true, false, 0, 1);  //DELETE SF RSG 02.2023 V2.0
                return Gen.Util.CS.Gen.convertToHtmlTableDelete(resultado, "tableToOrder", "table table-striped table-bordered' style='width:" + ancho + ";", listaEvitar, true, true, true, false, 0, 1);  //ADD SF RSG 02.2023 V2.0
            }
            else
            {
        ...
        public string consultarProveedorPorGrNoticia(string idGGrNoticia, string ancho)
        {
            ...
            {
                List<int> listaEvitar = new List<int>();
                //return Gen.Util.CS.Gen.convertToHtmlTableDelete(resultado, "tableToOrder", "tblComun' style='width:" + ancho + ";", listaEvitar, false, false, true, false, 0, 1);//DELETE SF RSG 02.2023 V2.0
                return Gen.Util.CS.Gen.convertToHtmlTableDelete(resultado, "tableToOrder", "table table-striped table-bordered' style='width:" + ancho + ";", listaEvitar, false, false, true, false, 0, 1);//ADD SF RSG 02.2023 V2.0
            }
            else
            {
        ...
        public string consultarGruposDeNoticia(string ancho)
        {
            ...
            {
                List<int> listaEvitar = new List<int>();
                //return Gen.Util.CS.Gen.convertToHtmlTableDelete(resultado, "tableToOrder", "tblComun' style='width:" + ancho + ";", listaEvitar, true, false, true, true, 0, 1);//DELETE SF RSG 02.2023 V2.0
                return Gen.Util.CS.Gen.convertToHtmlTableDelete(resultado, "tableToOrder", "table table-striped table-bordered' style='width:" + ancho + ";", listaEvitar, true, false, true, true, 0, 1);  //ADD SF RSG 02.2023 V2.0
            }
            else
            {
                return "<strong>No se encontraron resultados para mostrar en la tabla</strong>";
